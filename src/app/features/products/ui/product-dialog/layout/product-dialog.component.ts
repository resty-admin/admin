...
export class ProductDialogComponent implements OnInit {
	...
	readonly addCategoryTag = (name: string) =>
		firstValueFrom(this._categoriesService.openCreateCategoryDialog({ name, place: this.placeId }));

	readonly addAttributeGroupTag = (name: string) =>
		firstValueFrom(this._attributeGroupsService.openCreateAttributeGroupDialog({ name, place: this.placeId }));
